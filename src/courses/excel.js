...
import "./excel.css"
  function Analy(){
    return(
      <div className="bachgexcel">
        <div className="ana">
        <div className="firstone-bussi">
...
<p>Power Bi</p>
        ...
        <div className="excelproj">
          <h2>Industry Project</h2>
          <div className="confirst1">
            <div className="firstone-pro">
              <h5>Project 1</h5>
        ...
        <div className="excefirstrev">
          <h2>What other Learners are saying</h2>
          <div className="consecon2">

            <div className="firstone-revulast">
