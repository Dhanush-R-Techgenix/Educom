        ...
        <div className="projc">
          ...
          <div className="container6">
            <div className="msex-projc">
              ...
              <p>Develop a new version of a Password   </p>
              <p>manager can keep track of all the Password  </p>
              <p>that have sent for respective accounts</p>
            </div>
            <div className="msex-projc">
              <h5>Project 2</h5>
              <h3>Python Decorators</h3>
              <p>Implement a python decorator that should </p>
              <p>whaytever the decorated function   </p>
              <p> returns,and it to a file in a new line </p>
