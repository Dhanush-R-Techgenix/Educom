...
function Jbegi(){
    return(
        <div className="jmbachg">
        <div className="ana">
        <div className="sub-jbegin">
...
<p>The free JavaScript course will help you learn javaScript right from the basics to advanced  </p><br></br>
<p>concepts.you will explore the different type of applications that you can build using javaScript.</p><br></br>
<p>By the end of the course you will have adequates skills to build simple programs and web applications. </p><br></br>
<h4>17306 Ratings </h4>

<h5>52707 Learns</h5>
</div>
<div className="jbegin-skill">
    ...
    <p>Closure </p>
        ...
        <div className="sjb-lear">
            <h2>Who should learn</h2>
            <p id="jui">UI Developer</p>
            <p id="jsd">Software developers</p>
            <p id="jfsd">Full Stack developers</p>
            <p id="jwds">Web developers</p>
