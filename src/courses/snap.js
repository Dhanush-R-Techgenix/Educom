...
import "./snap.css"
 function Snap(){
    return(
        <div className="snbachg">
        <div className="ana">
        <div className="sub-snap">
<h1>Basics of Snapchat Marketing</h1>
...
<div className="snap-skill">
    <h2>Skills you will gain</h2>
    <p>Creating a Marketable Presence on Snapchat</p>
    <p>Brand Marketing on Snapchat</p>
    <p>Snapchat Advertisting and Partnerships</p>
    
    


        </div>
        <div className="snap-lear">
            <h2>Who should learn</h2>
            <p id="snmm">Marketing Managers</p>
            <p id="sndm">Digitial Marketing Executives</p>
            <p id="snmg">Management Graduates</p>
            <p id="sncw">Content Writers</p>
            <p id="sne">Entrepreneurs</p>
