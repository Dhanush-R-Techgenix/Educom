...
<div className="begin1-skill">
    ...
    <p>User authorization and authentication</p>
        ...
        <div className="begin-lear1">
            <h2>Who should learn</h2>
            <p id="asd1">Aspiring software Developers</p>
            <p id="datsc2">Data scientists</p>
            <p id="datan3">Data analysts</p>
            <p id="aien4">AI engineers</p>
            <p id="proen5">Programming enthusiasts</p>
            
        </div>
        <div className="projct">
          <h2>Industry Project</h2>
          <div className="container1">
            <div className="ten-projc">
              <h5>Project 1</h5>
